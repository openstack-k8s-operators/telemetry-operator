...
# openstack.org/ceilometer-operator-bundle:$VERSION and openstack.org/ceilometer-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/infrawatch/ceilometer-operator
