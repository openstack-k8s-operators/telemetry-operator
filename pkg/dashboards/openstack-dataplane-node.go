...
func OpenstackDataplaneNode(dsName string, hasDpdk bool) *corev1.ConfigMap {
	dashBoardOVN :=
		`{
        "__inputs": [],
        "__requires": [],
	...
	dashBaordFooter := `],
        ...
        "timezone": "utc",
        "title": "Openstack / Dataplane Node Exporter",
        "version": 0
    }`
	...
	dashboardCM := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "grafana-dashboard-openstack-dataplane-node",
		...
		Data: map[string]string{
			"openstack-dataplane-node.json": dashBoard,
		},
	}
