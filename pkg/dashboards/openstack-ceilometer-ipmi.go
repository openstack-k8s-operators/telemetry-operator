...
// Package dashboards provides OpenStack monitoring dashboard configurations
package dashboards
...
// OpenstackCeilometerIpmi creates a ConfigMap containing the OpenStack Ceilometer IPMI dashboard
