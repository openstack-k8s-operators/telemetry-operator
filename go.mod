...
require (
	...
	github.com/openstack-k8s-operators/dataplane-operator/api v0.0.0-20230622172332-b19f40262287
...
require (
	...
	github.com/openstack-k8s-operators/openstack-baremetal-operator/api v0.0.0-20230619033923-b51a7994eafe // indirect
