module github.com/openstack-k8s-operators/ceilometer-operator

go 1.19

replace github.com/openstack-k8s-operators/ceilometer-operator/api => ./api
...
require (
	...
	golang.stackrox.io/kube-linter v0.6.2 // indirect
