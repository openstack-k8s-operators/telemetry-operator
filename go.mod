...
require (
	...
	golang.stackrox.io/kube-linter v0.6.3 // indirect
...
replace github.com/openstack-k8s-operators/openstack-ansibleee-operator/api v0.0.0-20230413080303-6c030167e53b => github.com/jlarriba/openstack-ansibleee-operator/api v0.0.0-20230418101656-2091a3d4f992
