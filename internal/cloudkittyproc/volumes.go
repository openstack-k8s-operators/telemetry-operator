...
func GetVolumeMounts(instance *telemetryv1.CloudKittyProc) []corev1.VolumeMount {
	...
	return append(cloudkitty.GetVolumeMounts(cloudkitty.ServiceName+"-proc"), volumeMounts...)
}
