...
func (in *MetricStorageSpec) DeepCopyInto(out *MetricStorageSpec) {
	*out = *in
	if in.RedHatMetricStorage != nil {
		in, out := &in.RedHatMetricStorage, &out.RedHatMetricStorage
		*out = new(RedHatMetricStorage)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedHatMetricStorage) DeepCopyInto(out *RedHatMetricStorage) {
	*out = *in
	in.Storage.DeepCopyInto(&out.Storage)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedHatMetricStorage.
func (in *RedHatMetricStorage) DeepCopy() *RedHatMetricStorage {
	if in == nil {
		return nil
	}
	out := new(RedHatMetricStorage)
