...
func (in *CeilometerSpec) DeepCopyInto(out *CeilometerSpec) {
	*out = *in
	out.RabbitMQSelectors = in.RabbitMQSelectors
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RabbitMQSelector) DeepCopyInto(out *RabbitMQSelector) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RabbitMQSelector.
func (in *RabbitMQSelector) DeepCopy() *RabbitMQSelector {
	if in == nil {
		return nil
	}
	out := new(RabbitMQSelector)
	in.DeepCopyInto(out)
	return out
}
