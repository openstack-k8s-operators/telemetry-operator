...
const (
	...
	// ApacheImageContainerImage - default fall-back image for proxy container
	ApacheImageContainerImage     = "registry.redhat.io/ubi9/httpd-24:latest"
)
...
func SetupDefaultsCeilometer() {
	...
	ceilometerDefaults := CeilometerDefaults{
		...
		ProxyContainerImageURL:        util.GetEnvVar("RELATED_IMAGE_APACHE_IMAGE_URL_DEFAULT", ApacheImageContainerImage),
	}
